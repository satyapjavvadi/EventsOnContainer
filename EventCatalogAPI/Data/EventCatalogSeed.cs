        ...
        private static IEnumerable<EventItem> GetPreconfiguredEventItems()
        {
            return new List<EventItem>()
            {
                new EventItem() {EventTypeId=1, EventCategoryId=1, EventLocationId=1,
                    ...
                    Time="10/18/2019 4:00 P.M. - 5:00 P.M.", PictureURL = "http://externaleventbaseurltobereplaced/api/pic/1"},
                new EventItem() {EventTypeId=2, EventCategoryId=1, EventLocationId=1,
                    ...
                    Time = "12/05/2019 8:00 A.M - 8:00 P.M.", PictureURL = "http://externaleventbaseurltobereplaced/api/pic/2"},
                new EventItem() {EventTypeId=3, EventCategoryId=1, EventLocationId=1,
                    ...
                    Time ="1/20/2020 4:00 P.M. - 7:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/3"},
                new EventItem() {EventTypeId=1, EventCategoryId=2, EventLocationId=1,
                    ...
                    Time = "2/25/2020 8:00 A.M. 12:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/4"},
                new EventItem() {EventTypeId=2, EventCategoryId=2, EventLocationId=1,
                    ...
                    Time = "9/20/2019 2:00 P.M. - 9:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/5"},
                new EventItem() {EventTypeId=3, EventCategoryId=2, EventLocationId=1,
                    ...
                    Time = "Thursdays 8:00 P.M. - 9:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/6"},
                new EventItem() {EventTypeId=1, EventCategoryId=3, EventLocationId=1,
                    ...
                    Time = "11/28.2019 9:00 A.M. - 5:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/7"},
                ...
                new EventItem() {EventTypeId=3, EventCategoryId=3, EventLocationId=1,
                    ...
                    Time ="Tuesdays 7:00 P.M. - 8:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/9"},
                ...
                new EventItem() {EventTypeId=2, EventCategoryId=1, EventLocationId=2,
                    ...
                    Time ="11/28/2019 2:00 P.M. - 6:00 P.M." , PictureURL ="http://externaleventbaseurltobereplaced/api/pic/11"},
                new EventItem() {EventTypeId=3, EventCategoryId=1, EventLocationId=2,
                    ...
                    Time ="Every Monday 2:00 P.M. 3:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/12"},
                new EventItem() {EventTypeId=1, EventCategoryId=2, EventLocationId=2,
                    ...
                    Time = "12/06/2019 9:00 A.M. - 1:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/13"},
                new EventItem() {EventTypeId=2, EventCategoryId=2, EventLocationId=2,
                    ...
                    Time = "05/18/2020 6:00 P.M. - 8:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/14"},
                new EventItem() {EventTypeId=3, EventCategoryId=2, EventLocationId=2,
                    ...
                    Time = "9/21/2019 6:30 A.M. - 4:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/15"},
                ...
                new EventItem() {EventTypeId=2, EventCategoryId=3, EventLocationId=2,
                    ...
                    Time = "11/13/2019 5:00 P.M. - 6:00 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/17"},
                new EventItem() {EventTypeId=3, EventCategoryId=3, EventLocationId=2,
                    ...
                    Time = "9/18/2019 2:30 P.M. - 3:30 P.M.", PictureURL ="http://externaleventbaseurltobereplaced/api/pic/18"},
            };
        }
    }
}
